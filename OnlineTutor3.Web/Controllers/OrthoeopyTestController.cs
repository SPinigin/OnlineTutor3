...
namespace OnlineTutor3.Web.Controllers
{
    ...
    public class OrthoeopyTestController : Controller
    {
        ...
        // POST: OrthoeopyTest/ToggleActive/5
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> ToggleActive(int id)
        {
            ...
            {
                _logger.LogError(ex, "Ошибка при изменении статуса теста по орфоэпии {TestId}", id);
        ...
        // POST: OrthoeopyTest/DeleteAllQuestions/5
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> DeleteAllQuestions(int id)
        {
            ...
            {
                _logger.LogError(ex, "Ошибка в OrthoeopyTest/DeleteAllQuestions для ID: {TestId}", id);
