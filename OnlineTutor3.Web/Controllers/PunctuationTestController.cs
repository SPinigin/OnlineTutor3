...
namespace OnlineTutor3.Web.Controllers
{
    ...
    public class PunctuationTestController : Controller
    {
        ...
        // POST: PunctuationTest/ToggleActive/5
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> ToggleActive(int id)
        {
            ...
            {
                _logger.LogError(ex, "Ошибка при изменении статуса теста по пунктуации {TestId}", id);
        ...
        // POST: PunctuationTest/DeleteAllQuestions/5
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> DeleteAllQuestions(int id)
        {
            ...
            {
                _logger.LogError(ex, "Ошибка в PunctuationTest/DeleteAllQuestions для ID: {TestId}", id);
